...
def NetrunnerPath():
    ...
    text = appendWithNewLine(text, f"- {random.choice(LPD.TypeOfNetrunner)}")
...
def TechPath():
    text = "Tech\n"
    # append the random choice and a new line
    text = appendWithNewLine(text, f"- {random.choice(LPD.TypeOfTech)}")
    Rpathresult = input("""Do you have a partner or do you work alone ?
    1 for solo 2 for group
    """)
    if int(Rpathresult) == 1:
...
def FixerPath():
    text = "Fixer\n"
    # append the random choice and a new line
    text = appendWithNewLine(text, f"- You {random.choice(LPD.TypeOfFixer)}")
    Rpathresult = input("""Do you have a partner or do you work alone ?
    1 for solo 2 for group
    """)
    if int(Rpathresult) == 1:
